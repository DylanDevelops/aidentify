  ...
  return (
    <div className="max-w-md space-y-4">
      ...
      <div className="flex flex-col lg:flex-row lg:pt-[4.94rem] justify-center gap-4">
        <div className="flex-shrink-0 w-full lg:w-[17.1875rem] h-[10.9375rem] flex flex-col items-center justify-center bg-[linear-gradient(239deg,_rgba(183,_206,_206,_0.85)_0%,_rgba(110,_125,_133,_0.72)_219.48%)] rounded-[4.0625rem] lg:translate-y-0 border-[5px] border-solid border-[#A5B5B8] lg:animate-float" style={{ '--initial-translate-y': '0px', animationDelay: '0s' } as CSSProperties}>
        ...
        <div className="flex-shrink-0 w-full lg:w-[17.1875rem] h-[10.9375rem] flex flex-col items-center justify-center bg-[linear-gradient(239deg,_rgba(183,_206,_206,_0.85)_0%,_rgba(110,_125,_133,_0.72)_219.48%)] rounded-[4.0625rem] lg:translate-y-[-2.9rem] border-[5px] border-solid border-[#A5B5B8] lg:animate-float" style={{ '--initial-translate-y': '-2.9rem', animationDelay: '3s' } as CSSProperties}>
        ...
        <div className="flex-shrink-0 w-full lg:w-[17.1875rem] h-[10.9375rem] flex flex-col items-center justify-center bg-[linear-gradient(239deg,_rgba(183,_206,_206,_0.85)_0%,_rgba(110,_125,_133,_0.72)_219.48%)] rounded-[4.0625rem] lg:translate-y-[10px] border-[5px] border-solid border-[#A5B5B8] lg:animate-float" style={{ '--initial-translate-y': '10px', animationDelay: '0s' } as CSSProperties}>
