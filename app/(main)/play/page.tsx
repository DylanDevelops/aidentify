...
import { CalendarCheck, CalendarClock, ChevronRight, ImagePlay, Loader2, TextSearch } from "lucide-react";
      ...
      <div className="min-h-full flex flex-col">
        <div className="flex flex-col items-center justify-center text-center gap-y-8 flex-1 px-6 pb-10">
          <div className="flex flex-col justify-center gap-[2.81rem]">
            <div className={cn("flex-shrink-0 w-[22rem] h-[10.9375rem] flex flex-col items-center justify-center bg-[linear-gradient(101deg,_rgba(183,_206,_206,_0.85)_0%,_rgba(187,_186,_198,_0.85)_100%)] rounded-[2.5rem] border-[5px] border-solid border-[#AFBABD] transition-transform duration-300", !alreadyCompletedDailyChallenge ? "hover:scale-105 cursor-pointer" : "")} onClick={() => {
              if(!alreadyCompletedDailyChallenge) {
              ...
              <p className="pt-2 text-center mr-2 ml-2 font-[700] text-[1.375rem] text-[rgba(28,_15,_19,_0.50)] flex items-center">Daily Challenge {!alreadyCompletedDailyChallenge && <ChevronRight className="ml-1 stroke-[3]" />}</p>
              {alreadyCompletedDailyChallenge && (
